...
class MetricsManager(object):
    ...
    def report_val(self):
        ...
        kobe = self.metrics_val['loss']
        return metric_strs,kobe
...
class Trainer(object):
    ...
    def __init__(self,
        ...
        if self.save_summary:
            self.train_writer = SummaryWriter(
                os.path.join(self.save_dir, "logs", "data"))
    ...
    def train_epoch(self):
        ...
        for batch_id, inputs in enumerate(self.train_iter, 1):
            ...
            ########排除数据处理的bug2020.11.9######
            # c = inputs.cue[1].cuda().data.cpu().numpy()
            # if 2 in c:
            #     continue
            #####################################
            ...
            if batch_id % self.log_steps == 0:
                ...
                metrics_message, self.kobe = train_mm.report_val()
    ...
    def save(self, is_best=False):
        ...
        train_file = os.path.join(
            self.save_dir, "state_epoch_{}.data".format(self.epoch))
        ...
        self.logger.info("Saved data state to '{}'".format(train_file))

        if is_best:
            best_model_file = os.path.join(self.save_dir, "best.model")
            best_train_file = os.path.join(self.save_dir, "best.data")
    ...
    def load(self, file_prefix):
        ...
        train_file = "{}.data".format(file_prefix)
        ...
        self.logger.info(
            "Loaded data state from '{}' with (epoch-{} best_valid_metric-{:.3f})".format(
